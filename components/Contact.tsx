      ...
      <section id="booking" className="py-20 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="font-majer text-5xl text-primary-blue mb-2">Book Us</h2>
              <div className="relative h-[300px] md:h-[400px] mt-6 rounded-2xl overflow-hidden">
                <Image
            ...
            >
              <form onSubmit={handleSubmit} className="bg-bg-light p-8 rounded-2xl shadow-xl">
                <h3 className="font-majer text-3xl text-primary-blue mb-6 text-center">Get in TOUCH</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div>
                    <label htmlFor="rooms" className="block text-sm font-medium text-gray-700 mb-1">No. of Rooms</label>
                    <input
                      type="number"
                      id="rooms"
                      name="rooms"
                  ...
                  <div>
                    <label htmlFor="restrooms" className="block text-sm font-medium text-gray-700 mb-1">No. of RestRooms</label>
                    <input
                      type="number"
                      id="restrooms"
                      name="restrooms"
                  ...
                  <div>
                    <label htmlFor="landscape" className="block text-sm font-medium text-gray-700 mb-1">Number of Landscape</label>
                    <input
                      type="number"
                      id="landscape"
                      name="landscape"
                ...
                <button
                  type="submit"
                  className="w-full bg-primary-blue text-white font-majer text-xl py-3 px-6 rounded-lg hover:bg-dark-blue transition-colors"
                >
                  Submit Request
                </button>
              </form>
