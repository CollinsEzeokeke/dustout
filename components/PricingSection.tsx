    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className={`${activeTab !== "residential" ? "text-white" : "text-gray-800"} dark:text-gray-300 max-w-2xl mx-auto`}>
            Choose the perfect cleaning package for your needs, whether residential or industrial.
          </p>
        </div>
                ...
                <ul className="text-left space-y-3 mb-8 text-sm md:text-base">
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-start">
                      <div className={`rounded-full p-1 mr-3 flex-shrink-0 ${plan.checkBgColor} shadow-sm`}>
